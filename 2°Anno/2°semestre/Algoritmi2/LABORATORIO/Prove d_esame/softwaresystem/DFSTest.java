...
public class DFSTest {
	...
	{
		GraphInterface grafo =new UndirectedGraph ("4;0 1;0 2;2 3;3 0;1 2");
		DFS dfsTest = new DFS(grafo);
		assertEquals(dfsTest.isConnected(),true);
		GraphInterface grafo2 =new UndirectedGraph ("5;0 1;0 2;2 3;3 0;1 2");
		DFS dfsTest2 = new DFS(grafo2);
		assertEquals(dfsTest2.isConnected(),false);

	}
	@Test
	public void testconnectedComponents()
	{
		GraphInterface grafo =new UndirectedGraph ("9;0 1;1 2;1 3;2 3;3 4;7 6; 6 8");
		DFS dfsTest = new DFS(grafo);
		assertEquals(dfsTest.connectedComponents()[0],0);
		assertEquals(dfsTest.connectedComponents()[1],0);
		assertEquals(dfsTest.connectedComponents()[2],0);
		assertEquals(dfsTest.connectedComponents()[3],0);
		assertEquals(dfsTest.connectedComponents()[4],0);
		assertEquals(dfsTest.connectedComponents()[5],1);
		assertEquals(dfsTest.connectedComponents()[6],2);
		assertEquals(dfsTest.connectedComponents()[7],2);
		assertEquals(dfsTest.connectedComponents()[8],2);

	}
	@Test
	public void testhasUndirectedCycle()
	{
		GraphInterface grafo =new UndirectedGraph ("6;0 1;1 2;2 3;3 0;2 4;4 5");
		DFS dfsTest = new DFS(grafo);
		assertEquals(dfsTest.hasUndirectedCycle(),true);
		
		GraphInterface grafo2 =new UndirectedGraph ("5;0 1;1 2;2 3;3 4");
		DFS dfsTest2 = new DFS(grafo2);
		assertEquals(dfsTest2.hasUndirectedCycle(),false);
	}
}
