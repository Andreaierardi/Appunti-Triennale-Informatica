...
public class UndirectedGraph implements GraphInterfaceEs {
	/******************************
	...
	public UndirectedGraph(int nVert) { 
	...
	//restituisce gli archi incidenti nel nodo dato
	@Override
	...
	//	 //elimina l'arco (tail,head)
	public void removeEdge(int tail, int head){ //delete edge (tail,head)


		if(matrice[tail][head]==1)
		{
			matrice[tail][head]=matrice[head][tail]=0;
			peso[tail][head]= peso[head][tail]=-1;
			this.numberOfEdges--;
		}
	} 
